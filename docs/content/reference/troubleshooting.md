...
Most of these come down to network reality or how mangadex serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

mangadex rate-limits like any public site. mangadex already paces
...
Where a surface is gated, mangadex reads a cookie or token you supply
...
`mangadex`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what mangadex actually did
